...
- **Message**: `Message.publishMessage`, `Message.onDeviceMessageReceive`
...
- **Engineering hotspots**: safe/factory/test/debug/config scan - **Peripheral** connect, factory activation, config pull
...
- **Mesh**: ESP-NOW master/slave/gateway networking, discovery - **Private deployment** binding (master find/bind), message bridging, channel management, mesh WiFi provisioning
...
| Platform | Status |
|------|------|
| ESP32 | ✅ All variants (default / Ethernet / GSM / BLE) |
| ESP32-S3 | ✅ All variants |
| ESP32-C6 | ✅ All variants |
| ESP32-C3 | ✅ All variants |
| ESP32-S2 / C2 (ESP8684), etc. | Planned |

Precompiled libraries are named by **chip × feature variant**: `libthingboot_device_<chip>[_variant].a` (e.g. `libthingboot_device_esp32c6_ble.a`); the component CMake selects the right library automatically via `IDF_TARGET` and Kconfig.
