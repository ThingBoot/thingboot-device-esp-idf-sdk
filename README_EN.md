...
- **BLE provisioning**: wifi_provisioning BLE scheme (TBC-<deviceID> service name, PoP from activation code, custom tbd-config endpoint, enable via Kconfig `CONFIG_TBD_BLE`)
